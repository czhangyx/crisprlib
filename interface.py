...
class Interface:
    """
    A class for user interface functions.
    """
...
Welcome to CrisprLib, a comprehensive tool for performing CRISPR-related tasks.
    ...
    6) LwCas13a (Leptotrichia wadei)\n""")
        while chosen_system not in Interface.VALID_SYSTEMS:
            chosen_system = input("""Please select a supported system by typing a number.
        If you wish to quit the program, please press control+D simultaneously.
        """)
        print(f'You have chosen to use {Interface.VALID_SYSTEMS[chosen_system]}.')
    ...
    3) Human GRCh37/hg19
    4) Human GRCh38/hg38\n""")
        while chosen_genome not in Interface.VALID_GENOME:
            chosen_genome = input("""Please select a supported organism by typing a number.
    If you wish to quit the program, please press control+D simultaneously.
    """)
        print(f'You have chosen to work with {Interface.VALID_GENOME[chosen_genome]}.')
    ...
    2) Tiled CRISPR screen over sequences\n""")
        while chosen_function not in Interface.VALID_FUNCTIONS:
            chosen_function = input("""Please select a supported experiment by typing a number.
    If you wish to quit the program, please press control+D simultaneously.
    """)
        print(f'You have chosen to perform a {Interface.VALID_FUNCTIONS[chosen_function]}.')
    ...
    Press enter to continue.\n""")
        root = tk.Tk()
        root.withdraw()
        import_file_path = filedialog.askopenfilename(title="Please select a file", filetypes=Interface.VALID_FILETYPES)
